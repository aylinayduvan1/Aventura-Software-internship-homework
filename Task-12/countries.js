...
let most = document.getElementById('max-population');
let least = document.getElementById('min-population');
let ingilizce = document.getElementById('languages');
let para = document.getElementById('currency');
